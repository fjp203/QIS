	...
	<tr>
		...
		<td>
			<div class="uploadpic">
				<h3>正确状态</h3>
				<br/>
				<div class="up-content"><img id="GoodImgPr" src="/QIS/Public/images/nopic.gif" style="height:120px;width:120px" />
			...
			<div class="uploadpic">
				<h3>错误状态</h3>
				<br/>
				<div class="up-content"><img id="BadImgPr" src="/QIS/Public/images/nopic.gif" style="height:120px;width:120px" />
...
$("#GoodImgPr").attr("src", "/QIS/Public/images/nopic.gif");
$("#BadImgPr").attr("src", "/QIS/Public/images/nopic.gif");
}
...
function showpic() {
	...
	$('#showpic').dialog("open").dialog('setTitle', '&nbsp;&nbsp;图片浏览');
			...
			if(Aurl[0]){
				var urlOK=Aurl[0];
				$("#picshowOK").html(
						'<img id="imageFullScreenOK"    src=/QIS/public/' + urlOK
								+ '   alt=' + urlOK + '/>');
			...
			if(Aurl[1]){
				var urlCW=Aurl[1];
				$("#picshowCW").html(
						'<img id="imageFullScreenCW"    src=/QIS/public/' + urlCW
								+ '  alt=' + urlCW + '/>');
...
var url = row.file_big_img;
			...
			if(Aurl[0]){
				...
				$("#photo_viewOK").html(
						  '<img id="imageFullScreen1OK"    src=/QIS/public/' + urlOK
							+ ' alt=' + urlCW + '/>'
								);
			...
			if(Aurl[1]){
				var urlCW=Aurl[1];		
				$("#photo_viewCW").html(
						  '<img id="imageFullScreen1CW"   src=/QIS/public/' + urlCW
							+ ' alt=' + urlCW + '/>'				
				);
